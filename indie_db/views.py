...
def article(request):
    if request.method == 'GET' and 'id' in request.GET:
        ...
        return render(request, 'front/article.html', {'categories': categories, 'article': article, 'pages': pages})
...
def search_articles(request):
    ...
    try:
        ...
        # If page is out of range (e.g. 9999), deliver last page of results.
        articles = pager.page(pager.num_pages)
    return render(request, 'front/search_articles.html', {'how_categories': how_categories, 'categories': categories, 'pages': pages, 'articles': articles, 'total_results': pager.count, 'number_of_pages': pager.num_pages, 'page': page, 'search_string': search_string, 'search_display': search_display})
...
def search_artists(request):
    ...
    return render(request, 'front/search_artists.html', {'categories': categories, 'artists': artists, 'total_results': pager.count, 'number_of_pages': pager.num_pages, 'page': page, 'search_string': search_string, 'search_display': search_display, 'pages': pages})
...
def search_publishers(request):
    ...
    return render(request, 'front/search_publishers.html', {'categories': categories, 'publishers': publishers, 'total_results': pager.count, 'number_of_pages': pager.num_pages, 'page': page, 'search_string': search_string, 'search_display': search_display, 'pages': pages})
...
def single_work(request):
    ...
    if request.method == 'GET' and 'id' in request.GET:
        ...
        return render(request, 'front/single_work.html', {'categories': categories, 'work': work, 'articles': articles, 'pages': pages})
    else:
...
def single_publisher(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'front/single_publisher.html', {'categories': categories, 'publisher': publisher, 'works': works, 'pages': pages})
    else:
        return HttpResponseRedirect('/indie_db/works/search/')
